...
[![R-CMD-check](https://github.com/acoppock/metaprep/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/acoppock/metaprep/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
and `metafor::rma.mv()` implements them: you pass a block-diagonal
variance-covariance matrix that encodes the dependence. The annoying
part is building that matrix and keeping it synchronized with the
estimates as you filter, group, and subset.
